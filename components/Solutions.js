...
const Solutions = () => {
  ...
  return (
    <section
      id="solutions"
      className="py-32 bg-light
      max-md:py-5 overflow-hidden
    "
    >
      <div className="container px-4 mx-auto flex">
        ...
        >
          {/* Leftコンテンツ */}
          <div
            className="lg:w-6/12 relative mb-10 lg:mb-0 z-10
             before:content-[''] before:absolute before:right-1/2 
             before:w-screen before:rounded-tr-[200px] before:z-[-1]
             before:rounded-br-3xl before:py-28 before:-top-20 
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <div className="w-4/12 flex">
                    <div className="ml-auto">
                      {/* デザイン用の空Div */}
                      <div
                        className="bg-yellowLight w-10 h-10 lg:h-24 lg:w-24 
                      rounded-2xl rounded-bl-[200px] max-md:w-16 max-md:h-16"
                      />
                    </div>
                  </div>
              ...
              <div className="mt-auto">
                <div className="flex flex-col gap-2">
                  <div>
                    {/* デザイン用の空Div */}
                    <div
                      className="bg-purpleLight w-10 lg:w-20 
                    h-10 lg:h-20 rounded-2xl rounded-tr-[200px]
                  ...
                  <div>
                    <div
                      className="p-4 lg:p-10 shadow-2xl rounded-lg 
                    bg-white w-full leading-5"
                    >
                      <strong
                        className="block font-bold text-green 
          ...
          >
            <span
              ...
              before:bg-pinkLight before:left-0 before:top-0 before:bottom-0 
              before:-z-10"
              data-aos="fade-up"
              data-aos-delay="100"
            >
            ...
            <ul
              className="grid grid-cols-1 sm:grid-cols-2 w-full gap-4 md:gap-5
              mb-10"
              data-aos="fade-left"
              data-aos-delay="200"
            >
              {solutionsContent.text.features.map((item, index) => (
                // flex-growとは余った空間を全てつかう
                <li
                  key={index}
                  className="flex flex-grow items-center space-x-5"
                >
                  <span
                    className="w-7 h-7 rounded-full bg-green
                    flex items-center justify-center"
                  >
                    <FaCheck className="text-white w-[30px]" />
                  </span>
